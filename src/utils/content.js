    ...
    questions: [
      {
        ...
        answer:
          "TechFlow is an AI-powered note-taking application designed to \
      ...
      },
      {
        ...
        alt: "Magic Pen Icon",
        Icon: MagicPen,
        question: "How does TechFlow use AI to enhance note-taking?",
        answer:
          "TechFlow uses AI to automatically categorize, summarize, and tag your notes, \
      ...
      },
      {
        ...
        alt: "Two Users Icon",
        Icon: TwoUsers,
        question: "Can TechFlow be used for team collaboration?",
        answer:
          "Absolutely! TechFlow is designed to support both individual users and team collaboration. \
      ...
      },
      {
        ...
        alt: "Cloud Icon",
        Icon: Cloud,
        question: "Can I access TechFlow on multiple devices?",
        answer:
          "Yes, you can access TechFlow from any device, including your computer, tablet, \
    ...
    questions: [
      {
        ...
        answer:
          "TechFlow offers several pricing tiers to meet the needs of both individuals and teams. \
      ...
      },
      {
        ...
        alt: "Card Slash Icon",
        Icon: CardSlash,
        question: "Is there a free trial available for TechFlow?",
        answer:
          "TechFlow offers several pricing tiers to meet the needs of both individuals and teams. \
          We have a free plan with basic features, as well as premium plans that provide advanced features \
          like unlimited storage, team collaboration tools, and more. You can find detailed information about \
      ...
      },
      {
        ...
        alt: "Lock Icon",
        Icon: Lock,
        question: "Is my payment information secure with TechFlow?",
        answer:
          "Yes, we take your security very seriously. All payment transactions are processed through secure, encrypted \
          channels. TechFlow uses industry-standard security protocols to ensure your payment information is always protected. \
    ...
    questions: [
      {
        ...
        answer:
          "TechFlow's Smart Organization feature uses advanced AI to automatically categorize and tag your notes \
      ...
      },
      {
        ...
        answer:
          "Contextual Reminders use AI to analyze your notes and automatically recognize important tasks, deadlines, \
              and follow-up actions. Based on this analysis, TechFlow will send you timely reminders to ensure you never \
      ...
      },
      {
        ...
        answer:
          "Yes! TechFlow’s Voice-to-Text Transcription feature lets you dictate notes in real time. Whether you’re in a \
      ...
      },
      {
        ...
        answer:
          "Yes! With TechFlow’s intelligent search functionality, you can search for specific keywords, topics, or \
    ...
    questions: [
      {
        ...
        answer:
          "TechFlow integrates with a wide range of tools, including popular apps like Google Drive, Microsoft \
      ...
      },
      {
        ...
        alt: "Integrate Icon",
        Icon: Integrate,
        question: "Will TechFlow integrate with other apps in the future?",
        answer:
          "We are always working to expand our integration offerings to meet the needs of our users. We frequently \
        update TechFlow to support new and popular tools, so be sure to check back for new integrations that may \
      ...
      },
      {
        ...
        Icon: Import,
        question:
          "Can I import existing notes from other platforms into TechFlow?",
        answer:
          "Yes, you can easily import your existing notes from platforms like Evernote, Google Keep, and Microsoft \
        OneNote into TechFlow. This ensures a smooth transition without losing any of your important information.",
      },
      {
        id: 16,
        alt: "Slack Icon",
        Icon: Slack,
        question:
          "Does techFlow integrate with team collaboration tools like Slack?",
        answer:
          "Absolutely! TechFlow integrates with Slack, allowing you to share notes and collaborate in real time \
...
const testimonials = [
  {
    ...
    rating: 4,
    description:
      "TechFlow has completely transformed the way I manage my work notes. The AI-powered organization feature \
  ...
  },
  {
    ...
    rating: 5,
    description:
      "As a designer, I need a tool that helps me keep track of brainstorming sessions and project notes. TechFlow’s \
  ...
  },
  {
    ...
    TechFlow does the heavy lifting, automatically categorizing everything. It’s an indispensable part of my workflow.",
  ...
  },
  {
    ...
    rating: 4,
    description:
      "TechFlow has made managing multiple projects so much easier. I can quickly access and organize my notes, \
  ...
  },
  {
    ...
    rating: 5,
    description:
      "As a startup founder, my days are packed with meetings and ideas. TechFlow’s voice-to-text feature lets \
  ...
  },
  {
    ...
    rating: 4,
    description:
      "I’ve tried many note-taking apps, but none compare to TechFlow. The AI-driven categorization helps me keep my \
  ...
  },
  {
    ...
    Plus, I love how seamlessly it integrates with tools like Trello and Slack. TechFlow is a must-have for anyone in design.",
  ...
  },
  {
    ...
    based on my notes has made my follow-up process much smoother and more efficient. TechFlow has been a game-changer!",
  ...
  },
  {
    ...
    rating: 5,
    description:
      "I can’t say enough about how helpful TechFlow’s integrations are. Syncing my notes with Google Drive and other apps \
  ...
  },
  {
    ...
    rating: 4,
    description:
      "TechFlow has been a lifesaver for organizing meeting summaries. The AI organization \
  ...
  },
  {
    ...
    rating: 5,
    description:
      "With TechFlow, I’m able to keep track of ideas, strategies, and feedback effortlessly. The contextual reminders are perfect \
  ...
  },
  {
    ...
    rating: 4,
    description:
      "As someone who juggles multiple responsibilities, TechFlow keeps me organized without any hassle. The seamless integrations \
...
const features = {
  ...
  ContextualReminders: {
    ...
    description:
      ...
      context of your notes. TechFlow recognizes deadlines, follow-ups, and key actions \
